...
set circuit1 [readnet spice ../netlist/flat/sky130_od_ip__tempsensor_flat.spice]
set circuit2 [readnet spice ../netlist/schematic/sky130_od_ip__tempsensor_ext_vp.spice]

lvs "$circuit1 sky130_od_ip__tempsensor_flat" "$circuit2 sky130_od_ip__tempsensor_ext_vp" $PDK_PATH/$PDK/libs.tech/netgen/sky130A_setup.tcl sky130_od_ip__tempsensor_flat_comp.out
