...
set circuit1 [readnet spice $CACE_ROOT/netlist/layout/${ipname}_ext_vp.spice]
set circuit2 [readnet spice $hvlib]

#readnet spice $hdlib $circuit2
readnet spice $CACE_ROOT/netlist/schematic/${ipname}_ext_vp.spice $circuit2

#debug on

lvs "$circuit1 ${ipname}_ext_vp" "$circuit2 ${ipname}_ext_vp" $setupfile ${ipname}_ext_vp_comp.out -json
